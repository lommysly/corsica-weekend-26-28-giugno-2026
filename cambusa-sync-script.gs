...
function setupConfig(sheet) {
  ...
  sheet.getRange('A2:B9').setValues([
    ['persone', 12],
    ['data_inizio', '26/06/2026'],
    ['data_fine', '28/06/2026'],
    ['check_in_ora', '17:00'],
    ['check_out_ora', '17:00'],
...
var MENU_LIST = [
  ['26/06/2026', 'Venerdì',   '—',                 '',                          '',                           'Check-in 17:00 · Apericena in navigazione'],
  ['27/06/2026', 'Sabato',    'Colazione a bordo', 'Frittata alle erbe',         'Pesce spada alla messinese', ''],
  ['28/06/2026', 'Domenica',  'Colazione a bordo', 'Avocado toast con uova',     'Linguine tonno e limone',    ''],
];
...
function generaRiepilogo() {
  ...
  rSheet.getRange('A1:E1').merge()
    .setValue('LISTA SPESA — CORSICA EXPERIENCE  ·  26 Giu–29 Giu 2026  ·  ' + persone + ' persone · ' + giorni + ' giorni')
